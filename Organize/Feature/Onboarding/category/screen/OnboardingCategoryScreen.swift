//
//  OnboardingCategoryScreen.swift
//  Organize
//
...
protocol OnboardingCategoryScreenDelegate: AnyObject {
    func next()
    
    func skip()
}

class OnboardingCategoryScreen: UIView {
    
    private weak var delegate: OnboardingCategoryScreenDelegate?
    
    func delegate(delegate: OnboardingCategoryScreenDelegate) {
    ...
    lazy var routineImage:UIImageView = {
        ...
        img.image = UIImage(named: "onboarding_category")
        return img
    }()
    ...
    lazy var navSecondImage:UIImageView = {
        let img = UIImageView()
        img.translatesAutoresizingMaskIntoConstraints = false
        img.image = UIImage(named: "onboarding_nav_third")
        return img
    }()
    ...
    lazy var subtitleLabel:UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Você pode organizar sua rotina diária separada por categoria"
